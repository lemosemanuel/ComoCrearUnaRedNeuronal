...
def build_classifier(optimizer):
    ...
    classifier.add(Dense(units = 6, kernel_initializer = "uniform",  
                        activation = "relu", input_dim = 11))
    # p es el indicador de "desactivar la neurona"
    #p = 0.1 una neurona descativada , 0.2 es dos neuronas desactivadas
...
# busco mejores Hiperparametros
from sklearn.model_selection import GridSearchCV
classifier= KerasClassifier(build_fn=build_classifier)

#defino los hiperparametros que quiero mejorar
parameters={
    # empezamos con el tama;o del bloque y numero de epoch
    # entre corchetes vamos a poner los datos que queremos que analice
    'batch_size':[25,32],
    #pruebo con 100 y 500
    'nb_epoch':[100,500],
